...
{
  name=OpenGL,
  description={Open Graphics Library. Programm-Bilbiothek, die für das Zeichnen von Bildern und 3D-Objekten auf den Bildschirm zuständig ist.},
}

\newglossaryentry{tet} {
  name={Tetromino},
  description={Ein Tetromino ist ein zusammenhängender geometrischer Körper, der aus 4 Würfeln besteht. \cite{Tetromino}}
}

\newglossaryentry{geg}{
  name={Gameengine},
  description={Programmteil, der die Logik des Spiels steuert}
}
